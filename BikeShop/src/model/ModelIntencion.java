...
public class ModelIntencion {
    ...
    public ModelIntencion(int id_intencion, String alias_cliente_fk, String fabricante_fk, String datetime) {
    ...
    public Object[] toArray(){
        Object[] data = {id_intencion, alias_cliente_fk, fabricante_fk, datetime};
        return data;
    }
}